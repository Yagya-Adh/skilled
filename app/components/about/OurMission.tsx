...
const OurMission = () => {
  return (
    <section className="bg-white my-40 max-w-screen-2xl mx-auto px-10">
      <div className="grid grid-cols-1 md:grid-cols-6 gap-20 items-center">
        ...
        <div className="grid grid-cols-1 col-span-4  items-center mx-20 h-full">
          <article>
            ...
            <p className="text-skilled-gary-10 max-w-xl">
          ...
          <div className="my-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            {data?.slice(0, 2).map((list) => (
              <div key={list.id}>
                <h5 className="flex items-center py-1 my-1 font-bold">
                  <Image
                    src={list.icon}
                    className=""
                    alt="icons_"
                ...
                <p className="text-skilled-gary-10 text-sm max-w-60">
                  {list.slug}
                </p>
              </div>
            ))}
